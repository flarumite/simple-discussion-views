...
flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('flarumite-admin-simple-discussion-views', function () {
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_0__["extend"])(flarum_components_PermissionGrid__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'moderateItems', function (items) {
    items.add('resetViews', {
      icon: 'far fa-eye',
      label: flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.translator.trans('flarumite-simple-discussion-views.admin.permissions.reset_views_label'),
